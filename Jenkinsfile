    ...
    stages {
     ...
     post { 
        always { 
            ...
            slackSend channel: '#glorious-w-f-devops-alerts', COLOR_MAP[currentBuild.currentResult], message: "*${currentBuild.currentResult}:* Job ${env.JOB_NAME} build ${env.BUILD_NUMBER} \n More info at: ${env.BUILD_URL}"
